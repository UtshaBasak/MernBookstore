...
// Typed from the modules themselves: these are imported inside beforeAll so
// they bind to the test's own database connection.
let runSeed: (typeof import('../scripts/seed.js'))['runSeed'];
